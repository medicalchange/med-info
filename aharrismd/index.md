...
<div class="link-columns">
  <section class="link-card">
    ...
    <p class="section-updated"><strong>Last updated:</strong> {{ page.last_updated | date: "%B %d, %Y" }}</p>
    <ul>
  ...
  <section class="link-card">
    ...
    <ul>
      ...
      <li><a href="{{ '/assets/pdfs/acetaminophen-and-ibuprofen-dose-recommendations.pdf' | relative_url }}">Pediatric Acetaminophen and Ibuprofen Dose Recommendations</a></li>
